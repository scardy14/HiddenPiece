 ...
 * 
 * public Pagination(long totalPostCount) { this.totalPostCount=totalPostCount;
 * } public Pagination(long totalPostCount,long nowPage) {
 * this.totalPostCount=totalPostCount; this.nowPage=nowPage; } public long
 * getNowPage() { return nowPage; }
 *//**
	 ...
	 */
/*
 * public long getStartRowNumber() { return (this.nowPage - 1) *
 * this.postCountPerPage + 1; }
 *//**
	 ...
	 */
/*
 * public long getEndRowNumber() { long endRowNumber = this.nowPage *
 * this.postCountPerPage; if(endRowNumber > this.totalPostCount) { endRowNumber
 * = this.totalPostCount; } return endRowNumber; }
 *//**
	 * 총 페이지 수를 반환 <br>
	 * 
	 ...
	 */
/*
 * public long getTotalPage() { long totalPage = this.totalPostCount /
 * this.postCountPerPage; if(this.totalPostCount % this.postCountPerPage != 0) {
 * totalPage += 1; } return totalPage; }
 *//**
	 * 총페이지 그룹수를 반환 <br>
	 ...
	 */
/*
 * public long getTotalPageGroup() { long totalPageGroup = this.getTotalPage() /
 * this.pageCountPerPageGroup; if(this.getTotalPage() %
 * this.pageCountPerPageGroup != 0) { totalPageGroup += 1; } return
 * totalPageGroup; }
 *//**
	 ...
	 */
/*
 * public long getNowPageGroup() { long nowPageGroup = this.nowPage /
 * this.pageCountPerPageGroup; if(this.nowPage % this.pageCountPerPageGroup !=
 * 0) { nowPageGroup += 1; } return nowPageGroup; }
 *//**
	 ...
	 */
/*
 * public long getStartPageOfPageGroup() { return (this.getNowPageGroup() - 1) *
 * this.pageCountPerPageGroup + 1; }
 *//**
	 ...
	 */
/*
 * public long getEndPageOfPageGroup() { long endPage = this.getNowPageGroup() *
 * this.pageCountPerPageGroup; if(endPage > this.getTotalPage()) { endPage =
 * this.getTotalPage(); } return endPage; }
 *//**
	 ...
	 */
/*
 * public boolean isPreviousPageGroup() { boolean flag=false;
 * if(this.getNowPageGroup() > 1) { flag = true; } return flag; }
 *//**
	 ...
	 * @return flag
	 *//*
		 * public boolean isNextPageGroup() { boolean flag=false;
		 * if(this.getNowPageGroup() < this.getTotalPageGroup()) { flag = true; } return
		 * flag; } }
		 * 
		 */
...
public class Paging3 {
	...
	private NoticeBoardCriteria ncri;
	...
	private void pagingData() {
		...
		endPage = (int) (Math.ceil(ncri.getPage() / (double) displayPageNum) * displayPageNum);
		// endPage = (현재 페이지 번호 / 화면에 보여질 페이지 번호의 개수) * 화면에 보여질 페이지 번호의 개수
		startPage = (endPage - displayPageNum) + 1;
		// startPage = (끝 페이지 번호 - 화면에 보여질 페이지 번호의 개수) + 1
		
		int tempEndPage = (int) (Math.ceil(totalCount / (double) ncri.getPerPageNum()));	
		...
		next = endPage * ncri.getPerPageNum() >= totalCount ? false : true;
	...
	public void setCri(NoticeBoardCriteria ncri) {
		this.ncri = ncri;
	}
	...
	public String toString() {
		return "PageMaker [totalCount=" + totalCount + ", startPage=" + startPage + ", endPage=" + endPage + ", prev="
				+ prev + ", next=" + next + ", displayPageNum=" + displayPageNum + ", ncri=" + ncri + "]";
	}
